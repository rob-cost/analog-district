...
var _getNextTickFunction = _interopRequireDefault(require("./getNextTickFunction.js"));
...
// * "change"
//
var Database = exports["default"] = /*#__PURE__*/function (_EventEmitter) {
  ...
  function Database(filename, mode, callback) {
    ...
    var initSqlJsPromise = config.initSqlJs ? Promise.resolve(config.initSqlJs) : isNodeJs ? Promise.resolve().then(function () {
      return _interopRequireWildcard(require('sql.js'));
    }).then(function (_) {
      return _["default"];
...
var nextTick = (0, _getNextTickFunction["default"])();
